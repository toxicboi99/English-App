...
export default function HomePage() {
  return (
    <main className="relative overflow-hidden">
      <section className="hero-grid mx-auto min-h-screen max-w-7xl px-6 py-8 lg:px-8">
        <div className="panel relative overflow-hidden rounded-[2.5rem] border-white/80 bg-white/75 p-8 md:p-12">
          ...
          <div className="relative grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="space-y-8">
              ...
              <div className="space-y-5">
                <h1 className="max-w-3xl font-[var(--font-display)] text-5xl leading-tight text-slate-950 md:text-7xl">
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/register">
                  <Button className="px-7 py-3 text-base">Start Learning</Button>
                </Link>
                <Link href="/login">
                  <Button className="px-7 py-3 text-base" variant="ghost">
                    Log In
                  </Button>
                </Link>
              </div>
